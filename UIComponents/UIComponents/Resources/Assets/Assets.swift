...
public enum Asset {
  ...
  public enum Icons {
    ...
    public static let paperIcon = ImageAsset(name: "paperIcon")
    public static let shareIcon = ImageAsset(name: "shareIcon")
  }
  public enum Images {
    public static let camera = ImageAsset(name: "camera")
    public static let clap = ImageAsset(name: "clap")
    public static let cloud = ImageAsset(name: "cloud")
    public static let colorPicker = ImageAsset(name: "colorPicker")
    public static let gallery = ImageAsset(name: "gallery")
    public static let headOutline = ImageAsset(name: "headOutline")
    public static let imgOnboard1 = ImageAsset(name: "imgOnboard1")
    public static let imgOnboard2 = ImageAsset(name: "imgOnboard2")
    public static let imgOnboard3 = ImageAsset(name: "imgOnboard3")
    ...
    public static let mockPerson = ImageAsset(name: "mockPerson")
    public static let paywallBg = ImageAsset(name: "paywallBg")
